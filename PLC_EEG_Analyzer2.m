...
for s = allsubs
    ...
    for b = bs
        ...
        %     else
        EEG = pop_eegthresh(EEG,1,99:101,-75,75,-0.2,0.3,0,0); %On EX3, EX4 and EX5, mark trials outside -75 to 75 uV
        %     end
...
save PLC_EEG_eegintrejtrials.mat allsubs_feareegintrejtrials
save PLC_EEG_ChanInfo.mat fearallchaninfo
