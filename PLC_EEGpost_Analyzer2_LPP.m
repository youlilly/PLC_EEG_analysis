...
for s = allsubs
    ...
    for b = bs
        ...
        EEG = pop_eegthresh(EEG,1,97:99,-90,90,-0.1,0.75,0,0); %On EX3, EX4 and EX5, mark trials outside -75 to 75 uV
        %     end
...
bs = 4:6;
    ...
    for b = bs
        ...
        EEG = pop_eegthresh(EEG,1,255:257,-90,90,-0.1,0.75,0,0); %On EX3, EX4 and EX5, mark trials outside -75 to 75 uV
        %     end
